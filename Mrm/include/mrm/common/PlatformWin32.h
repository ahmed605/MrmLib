...
#define WRITE_MRMMIN_INIT_TRACE_INFO(msg, hr) hr;
...
#define WRITE_MRMMIN_INIT_TRACE_INFO_CHECK(msg, hr) { hr; }
...
#define WRITE_MRMMIN_INIT_TRACE_ERROR(msg, hr) hr;
/*#define WRITE_MRMMIN_INIT_TRACE_ERROR_CHECK(msg, hr) \
    { \
        MrtRuntimeTraceLoggingProvider::TelemetryGenericEvent(TOWIDE(__FUNCTION__), RemovePiiUserProfileFilename(msg), hr); \
    }*/
#define WRITE_MRMMIN_INIT_TRACE_ERROR_CHECK(msg, hr) { hr; }
...
#define WRITE_MRMMIN_INIT_TRACE_ERROR_MEASURE(msg, hr) { LOG_ERROR_IN_MEMORY(hr, __LINE__, __FILE__, msg); }
...
#define WRITE_MRMMIN_INIT_TRACE_ERROR_MEASURE_CHECK(msg, hr) { LOG_ERROR_IN_MEMORY(hr, __LINE__, __FILE__, msg); }
...
#define WRITE_MRMMIN_TRACE_INFO(msg, msg2, hr) hr;
...
#define WRITE_MRMMIN_TRACE_WARNING(msg, msg2, hr) hr;
...
#define WRITE_MRMMIN_TRACE_WARNING_CHECK(msg, msg2, hr) { hr; }
...
#define WRITE_MRMMIN_TRACE_ERROR(msg, msg2, hr) hr;
...
#define WRITE_MRMMIN_TRACE_ERROR_MEASURE(msg, msg2, hr) { LOG_ERROR_IN_MEMORY(hr, __LINE__, __FILE__, msg2); }
...
#define WRITE_MRMMIN_TRACE_ERROR_MEASURE_CHECK(msg, msg2, hr) { LOG_ERROR_IN_MEMORY(hr, __LINE__, __FILE__, msg2); }
